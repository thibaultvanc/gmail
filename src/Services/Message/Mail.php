...
namespace Organit\LaravelGmail\Services\Message;

use Carbon\Carbon;
use Organit\LaravelGmail\GmailConnection;
use Organit\LaravelGmail\Traits\HasDecodableBody;
use Organit\LaravelGmail\Traits\Modifiable;
use Organit\LaravelGmail\Traits\Replyable;
use Google_Service_Gmail;
use Illuminate\Support\Collection;

/**
 * Class SingleMessage
 * @package Organit\LaravelGmail\services
 */
